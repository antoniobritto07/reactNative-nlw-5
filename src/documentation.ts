// Async Storage é uma ferramenta usada para armazenar dados no proprio dispositivo
// movel da pessoa que está usando a aplicação, da mesma forma que trabalha o
